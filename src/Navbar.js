...
import { faSearch, faBars, faTimes, faArrowDown } from '../node_modules/@fortawesome/free-solid-svg-icons';
...
function Navbar() {
    ...
    return (
        <>
            ...
            {show ? <div className="offcanvas-menu-overlay"></div> : null}
            {show ? <div className="offcanvas-menu-wrapper">
                <div className="canvas-close" onClick={() => setshow(false)}>
                    <FontAwesomeIcon icon={faTimes} />
                </div>
                <div className="canvas-search search-switch"  onClick={() => setshow3(!show3)}>
                    <FontAwesomeIcon icon={faSearch} />
                </div>
                {show3 ?<input type="text" className="search_input"/>:null}
                <nav className="canvas-menu mobile-menu">
                    <ul>
                        ...
                        <li>
                            <a href="#" onClick={() => setshow2(!show2)}>Pages <FontAwesomeIcon icon={faArrowDown} /></a>

                            {show2 ? <ul className="dropdown">
                                <li><a href="./about-us.html">About us</a></li>
            ...
            <header className="header-section">
                <div className="container-fluid">
                        ...
                        <div className="col-lg-6">
                            <nav className="nav-menu">
                                <ul>
                                    ...
                                    <li><NavLink exact activeClassName="active" to="/classes">Classes</NavLink></li>
                                    <li><NavLink exact activeClassName="active" to="/service">Services</NavLink></li>
                                    <li><NavLink exact activeClassName="active" to="/team">Our Team</NavLink></li>
                                    <li><a href="#">Pages</a>
                    ...
                    <div className="canvas-open" onClick={() => setshow(true)}>
